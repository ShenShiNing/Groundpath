...
function shouldRunRealIntegration(): boolean {
  if (process.env.RUN_REAL_DOCUMENT_INDEX_LIFECYCLE_INTEGRATION === '1') {
    return true;
  }
  ...
  return (
    envFromFile.RUN_REAL_DOCUMENT_INDEX_LIFECYCLE_INTEGRATION === '1' ||
    envFromFile.RUN_REAL_DOCUMENT_LIFECYCLE_INTEGRATION === '1'
  );
}
